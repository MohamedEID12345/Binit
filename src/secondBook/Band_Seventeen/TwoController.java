 ...
 */
package secondBook.Band_Seventeen;
...
DraggableMaker draggablemaker = new DraggableMaker();
    ...
    private void Dargteen(ActionEvent event) {
        ...
        rules.back();
        rules.back();
        draggablemaker.trueAction("/secondBook/Band_Seventeen/Three.fxml", event);
    }
    ...
    private void Zero(ActionEvent event) {
        draggablemaker.falseAction("/secondBook/Band_Seventeen/Three.fxml", event);
    }
