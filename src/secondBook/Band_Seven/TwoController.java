...
DraggableMaker draggablemaker = new DraggableMaker();
    ...
    public void initialize(URL url, ResourceBundle rb) {
         draggablemaker.makeDraggable(masa);
    }    
    ...
    private void True(ActionEvent event) {
        ...
        rules.back();
        draggablemaker.trueAction("/secondBook/Band_Seven/Three.fxml", event);
    }

    @FXML
    private void False(ActionEvent event) {
        draggablemaker.falseAction("/secondBook/Band_Seven/Three.fxml", event);
    }
