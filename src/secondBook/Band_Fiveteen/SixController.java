...
DraggableMaker draggablemaker = new DraggableMaker();
    ...
    private void True1(ActionEvent event) {
        ...
        rules.back();
        draggablemaker.trueAction("/secondBook/Band_Sixteen/One.fxml", event);
         rules.backrules15("/secondBook/Band_Eleven/One.fxml",event);
        
    }

    @FXML
    private void False1(ActionEvent event) {
        draggablemaker.falseAction("/secondBook/Band_Sixteen/One.fxml", event);
        Rules rules = new Rules();
        rules.backrules15("/secondBook/Band_Eleven/One.fxml",event);
    }
