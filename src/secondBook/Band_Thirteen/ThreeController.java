...
DraggableMaker draggablemaker = new DraggableMaker();
    ...
    private void Dargteen(ActionEvent event) {
        ...
        rules.back();
        rules.back();
        draggablemaker.trueAction("/secondBook/Band_Fourteen/One.fxml", event);
        rules.backrules13("/secondBook/Band_Nine/One.fxml",event);
    }
    ...
    private void Zero(ActionEvent event) {
        draggablemaker.falseAction("/secondBook/Band_Fourteen/One.fxml", event);
        Rules rules = new Rules();
        rules.backrules13("/secondBook/Band_Nine/One.fxml",event);
    }
