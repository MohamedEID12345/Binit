...
DraggableMaker draggablemaker = new DraggableMaker();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        l=0;
         System.out.println("hello band two");
    }    
    ...
    private void True(ActionEvent event) {
        ...
        rules.back();
        draggablemaker.trueAction("/secondBook/Band_Ten/Two.fxml", event);
        System.out.println("hello band two");
    }

    @FXML
    private void False(ActionEvent event) {
        draggablemaker.falseAction("/secondBook/Band_Ten/Two.fxml", event);
    }
