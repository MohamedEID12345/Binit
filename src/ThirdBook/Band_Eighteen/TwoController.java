...
DraggableMaker draggablemaker = new DraggableMaker();
    ...
    private void Darga(ActionEvent event) {
        ...
        score.thirdEstdlalKamy6();
        Code code=new Code();
        code.back();
        draggablemaker.trueAction("/ThirdBook/Band_Eighteen/Three.fxml", event);
    }

    @FXML
    private void Zero(ActionEvent event) {
        draggablemaker.falseAction("/ThirdBook/Band_Eighteen/Three.fxml", event);
    }
