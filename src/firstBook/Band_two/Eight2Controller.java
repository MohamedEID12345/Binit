 ...
 * @author eid
 */
public class Eight2Controller implements Initializable {
OneController one=new OneController();
    @FXML
    private Label erorrText12;
    @FXML
    private ImageView dog12;
Band_FiveController bandfivecontroller=new Band_FiveController();
    ...
    Timeline timeline = new Timeline(new KeyFrame(Duration.seconds(3), ev -> {
        //one.openStage(event, "/firstBook/Band_two/nine2.fxml");
        System.out.println(bandfivecontroller.stoprules(event,"/firstBook/Band_two/nine2.fxml"));
    }));
    timeline.play();
    //end method
    }
    ...
    private void five12(MouseEvent event) {
        try {
            ...
            bandfivecontroller.succesSound();
                Parent part = FXMLLoader.load(getClass().getResource("/firstBook/Band_two/nine2.fxml"));
