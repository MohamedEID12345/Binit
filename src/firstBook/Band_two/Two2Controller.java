 ...
 * @author eid
 */
public class Two2Controller implements Initializable {
OneController one=new OneController();
    @FXML
    private Label erorrText6;
    @FXML
    private ImageView twocolumn6;
Band_FiveController bandfivecontroller=new Band_FiveController();
    ...
    @FXML
    private void one6(MouseEvent event) {
        //erorr Pane Content
        erorrText6.setText("لا إنت هتختار زي دي");
        one.paneContentMessage(twocolumn6);
        //open new scane
    ...
    @FXML
    private void two6(MouseEvent event) {
        //erorr Pane Content
        erorrText6.setText("لا إنت هتختار زي دي");
        one.paneContentMessage(twocolumn6);
        //open new scane
    ...
    @FXML
    private void three6(MouseEvent event) {
        //erorr Pane Content
        erorrText6.setText("لا إنت هتختار زي دي");
        one.paneContentMessage(twocolumn6);
        //open new scane
    ...
    @FXML
    private void four6(MouseEvent event) {
        //erorr Pane Content
        erorrText6.setText("لا إنت هتختار زي دي");
        one.paneContentMessage(twocolumn6);
        //open new scane
    ...
    private void five6(MouseEvent event) {
        try {
            ...
            bandfivecontroller.succesSound();
                Parent part = FXMLLoader.load(getClass().getResource("/firstBook/Band_two/three2.fxml"));
