...
Band_FiveController bandfivecontroller=new Band_FiveController();
    @FXML
    private JFXRadioButton dargteen18;
    @FXML
    private ToggleGroup band18;
    @FXML
    private JFXRadioButton darga18;
    @FXML
    private JFXRadioButton zero18;
    ...
    @FXML
    private void Dargteen18(ActionEvent event) {
        if(dargteen18.isSelected()){
        ...
        FXMLLoader loader =new FXMLLoader(getClass().getResource("/firstBook/Band_Five/Five/Five.fxml"));
    ...
    @FXML
    private void Darga18(ActionEvent event) {
        if(darga18.isSelected()){
            DegreeCount score = new DegreeCount();
        score.firstTwo();
        score.firstOneVal();
    ...
    @FXML
    private void Zero18(ActionEvent event) {
        if(zero18.isSelected()){
             
            bandfivecontroller.faillSound();
            //System.out.println(bandfivecontroller.degreeDecreese());
//        Parent part = FXMLLoader.load(getClass().getResource("/firstBook/Band_Five/Five/Five.fxml"));
//        Stage stage = new Stage();
...
//        stage.show();
//        ((Node)(event.getSource())).getScene().getWindow().hide();
System.out.println(bandfivecontroller.stoprulesAction(event,"/firstBook/Band_Five/Five/Five.fxml"));
