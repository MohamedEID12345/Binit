...
Band_FiveController bandfivecontroller=new Band_FiveController();
    @FXML
    private JFXRadioButton dargteen15;
    @FXML
    private ToggleGroup band15;
    @FXML
    private JFXRadioButton darga15;
    @FXML
    private JFXRadioButton zero15;
    ...
    @FXML
    private void Dargteen15(ActionEvent event) {
        if(dargteen15.isSelected()){
        ...
        FXMLLoader loader =new FXMLLoader(getClass().getResource("/firstBook/Band_Five/Five/Two.fxml"));
    ...
    @FXML
    private void Darga15(ActionEvent event) {
        if(darga15.isSelected()){
            DegreeCount score = new DegreeCount();
        score.firstTwo();
        score.reseetFirstOneVal();
        score.firstOneVal();
    ...
    @FXML
    private void Zero15(ActionEvent event) {
        if(zero15.isSelected()){
            
            bandfivecontroller.faillSound();
            //System.out.println(bandfivecontroller.degreeDecreese());
//        Parent part = FXMLLoader.load(getClass().getResource("/firstBook/Band_Five/Five/Two.fxml"));
//        Stage stage = new Stage();
...
System.out.println(bandfivecontroller.stoprulesAction(event,"/firstBook/Band_Five/Five/Two.fxml"));
