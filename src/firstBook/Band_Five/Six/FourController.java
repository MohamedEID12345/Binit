...
Band_FiveController bandfivecontroller=new Band_FiveController();
    @FXML
    private JFXRadioButton dargteen24;
    @FXML
    private ToggleGroup band24;
    @FXML
    private JFXRadioButton darga24;
    @FXML
    private JFXRadioButton zero24;
    ...
    @FXML
    private void Dargteen24(ActionEvent event) {
        if(dargteen24.isSelected()){
        ...
        FXMLLoader loader =new FXMLLoader(getClass().getResource("/firstBook/Band_Five/Six/Five.fxml"));
    ...
    @FXML
    private void Darga24(ActionEvent event) {
        if(darga24.isSelected()){
            DegreeCount score = new DegreeCount();
        score.firstTwo();
        score.firstOneVal();
    ...
    @FXML
    private void Zero24(ActionEvent event) {
        if(zero24.isSelected()){
          
            bandfivecontroller.faillSound();
            //System.out.println(bandfivecontroller.degreeDecreese());
//        Parent part = FXMLLoader.load(getClass().getResource("/firstBook/Band_Five/Six/Five.fxml"));
//        Stage stage = new Stage();
...
//        stage.show();
//        ((Node)(event.getSource())).getScene().getWindow().hide();
System.out.println(bandfivecontroller.stoprulesAction(event,"/firstBook/Band_Five/Six/Five.fxml"));
