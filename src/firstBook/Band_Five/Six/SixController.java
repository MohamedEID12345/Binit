...
Band_FiveController bandfivecontroller=new Band_FiveController();
    @FXML
    private JFXRadioButton dargteen26;
    @FXML
    private ToggleGroup band26;
    @FXML
    private JFXRadioButton darga26;
    @FXML
    private JFXRadioButton zero26;
    ...
    @FXML
    private void Dargteen26(ActionEvent event) {
        if(dargteen26.isSelected()){
            
        try {
             bandfivecontroller.succesSound();
         System.out.println(bandfivecontroller.degreeDoubleIncreese());
        FXMLLoader loader =new FXMLLoader(getClass().getResource("/firstBook/Band_Five/Six/Seven.fxml"));
    ...
    @FXML
    private void Darga26(ActionEvent event) {
        if(darga26.isSelected()){
    ...
    @FXML
    private void Zero26(ActionEvent event) {
        if(zero26.isSelected()){
            bandfivecontroller.faillSound();
            //System.out.println(bandfivecontroller.degreeDecreese());
//        Parent part = FXMLLoader.load(getClass().getResource("/firstBook/Band_Five/Six/Seven.fxml"));
//        Stage stage = new Stage();
...
//        stage.show();
//        ((Node)(event.getSource())).getScene().getWindow().hide();
System.out.println(bandfivecontroller.stoprulesAction(event,"/firstBook/Band_Five/Six/Seven.fxml"));
